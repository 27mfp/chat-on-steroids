...
| [@igorbelchior86](https://github.com/igorbelchior86) | Restoring native macOS fullscreen through the existing window option: [#245](https://github.com/totec448-spec/chat-on-steroids/pull/245). |
