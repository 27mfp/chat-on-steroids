...
(() => {
  ...
  function pickerSnapshot() {
    ...
    const form = document.querySelector('#prompt-textarea, #pending-conversation-input, form[data-chatgpt-composer] [contenteditable="true"][role="textbox"]')?.closest('form');
